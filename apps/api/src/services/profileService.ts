...
export async function upsertProfile(
  ...
  if (existing) {
    const r = await pool.query<UserProfile>(
      ...
      [
        ...
        params.target_roles     ? JSON.stringify(params.target_roles)     : null,
        params.target_locations ? JSON.stringify(params.target_locations) : null,
        params.min_salary       ?? null,
        params.preferred_work_type ?? null,
        params.skills           ? JSON.stringify(params.skills)           : null,
  ...
  const r = await pool.query<UserProfile>(
    ...
    [
      ...
      params.headline            ?? null,
      params.location            ?? null,
      JSON.stringify(params.target_roles     ?? []),
      JSON.stringify(params.target_locations ?? []),
      params.min_salary          ?? null,
