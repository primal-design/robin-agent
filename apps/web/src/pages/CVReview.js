...
export function CVReview() {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "page-header", children: [_jsx("h1", { className: "page-title", children: "CV Review" }), _jsx("p", { className: "page-sub", children: "Two AI recruiters with 20 years experience review your CV in parallel." })] }), !result && !loading && (_jsxs("div", { className: "card", style: { maxWidth: 540 }, children: [_jsxs("div", { style: { display: 'flex', gap: 20, marginBottom: 20 }, children: [_jsxs("div", { style: { flex: 1, padding: '16px', background: 'var(--surface-1)', borderRadius: 10 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }, children: [_jsx(Brain, { size: 18, style: { color: 'var(--accent)' } }), _jsx("span", { style: { fontWeight: 600, fontSize: 13 }, children: "Claude Opus 4.8" })] }), _jsx("p", { className: "text-sm text-muted", children: "Senior in-house recruiter & hiring manager. Would they call you?" })] }), _jsxs("div", { style: { flex: 1, padding: '16px', background: 'var(--surface-1)', borderRadius: 10 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }, children: [_jsx(Building2, { size: 18, style: { color: 'var(--success)' } }), _jsx("span", { style: { fontWeight: 600, fontSize: 13 }, children: "GPT-4o" })] }), _jsx("p", { className: "text-sm text-muted", children: "Agency recruiter. ATS score, keyword gaps, marketability." })] })] }), error && _jsx("div", { className: "banner banner-danger", style: { marginBottom: 16 }, children: error }), _jsx("button", { className: "btn btn-primary w-full", onClick: runReview, children: "Run CV Review \u2014 takes ~20 seconds" })] })), loading && (_jsxs("div", { className: "card", style: { maxWidth: 540, textAlign: 'center', padding: '48px 24px' }, children: [_jsx("div", { className: "spinner", style: { margin: '0 auto 16px', width: 28, height: 28 } }), _jsx("div", { style: { fontWeight: 500 }, children: "Two AI recruiters are reading your CV\u2026" }), _jsx("p", { className: "text-sm text-muted", style: { marginTop: 6 }, children: "Claude Opus + GPT-4o running in parallel. ~20 seconds." })] })), result && (_jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, maxWidth: 1000 }, children: [_jsxs("div", { className: "card", children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }, children: [_jsx(Brain, { size: 16, style: { color: 'var(--accent)' } }), _jsx("span", { style: { fontWeight: 600, fontSize: 13, color: 'var(--accent)' }, children: "Claude Opus \u00B7 In-house Recruiter" })] }), _jsxs("div", { style: { padding: '12px', background: result.inhouse.would_call ? 'var(--success-light)' : 'var(--danger-light)', borderRadius: 8, marginTop: 12 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 13, color: result.inhouse.would_call ? 'var(--success)' : 'var(--danger)' }, children: result.inhouse.would_call ? '✓ Would call for interview' : '✗ Would not call' }), _jsx("div", { style: { fontSize: 13, marginTop: 4 }, children: result.inhouse.verdict })] }), _jsx(Section, { title: "First impression", children: _jsx("p", { className: "text-sm", children: result.inhouse.first_impression }) }), _jsx(Section, { title: "Strengths", children: _jsx(BulletList, { items: result.inhouse.strengths, variant: "success" }) }), _jsx(Section, { title: "Weaknesses", children: _jsx(BulletList, { items: result.inhouse.weaknesses, variant: "danger" }) }), _jsx(Section, { title: "Improvements", children: _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 }, children: result.inhouse.improvements.map((imp, i) => (_jsxs("div", { style: { display: 'flex', gap: 10, alignItems: 'flex-start' }, children: [_jsx("span", { className: `badge ${priorityColor(imp.priority)}`, style: { flexShrink: 0, marginTop: 1 }, children: imp.priority }), _jsx("span", { className: "text-sm", children: imp.action })] }, i))) }) })] }), _jsxs("div", { className: "card", children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }, children: [_jsx(Building2, { size: 16, style: { color: 'var(--success)' } }), _jsx("span", { style: { fontWeight: 600, fontSize: 13, color: 'var(--success)' }, children: "GPT-4o \u00B7 Agency Recruiter" })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 16, marginTop: 12, padding: 12, background: 'var(--surface-1)', borderRadius: 8 }, children: [_jsx(ATSRing, { score: result.agency.ats_score }), _jsxs("div", { children: [_jsx("div", { style: { fontWeight: 600 }, children: "ATS Score" }), _jsx("div", { className: "text-sm text-muted", children: result.agency.ats_score >= 70 ? 'Likely to pass ATS filters' : result.agency.ats_score >= 50 ? 'May pass — improvements needed' : 'High risk of ATS rejection' })] })] }), _jsx(Section, { title: "Marketability", children: _jsx("p", { className: "text-sm", children: result.agency.marketability }) }), _jsx(Section, { title: "Keywords present", children: _jsx("div", { className: "job-tags", children: result.agency.keyword_hits.map(k => _jsx("span", { className: "badge badge-success", children: k }, k)) }) }), _jsx(Section, { title: "Missing keywords", children: _jsx("div", { className: "job-tags", children: result.agency.keyword_gaps.map(k => _jsx("span", { className: "badge badge-danger", children: k }, k)) }) }), _jsx(Section, { title: "ATS issues", children: _jsx(BulletList, { items: result.agency.ats_issues, variant: "danger" }) }), _jsx(Section, { title: "Quick wins", children: _jsx(BulletList, { items: result.agency.quick_wins, variant: "neutral" }) })] })] })), result && (_jsx("button", { className: "btn btn-secondary btn-sm", style: { marginTop: 20 }, onClick: () => { setResult(null); setError(''); }, children: "Run again" }))] }));
}
