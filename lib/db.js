...
export async function loadSession(id) {
  if (redis) {
    ...
    return data || { messages: [], facts: [], streak: 0, tasks_done: 0, total_earned: 0, rejection_round: 0 }
  }
  const store = loadFile()
  return store[id] || { messages: [], facts: [], streak: 0, tasks_done: 0, total_earned: 0, rejection_round: 0 }
}
